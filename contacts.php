	...
	<div class="sixteen columns">
		...
		<div class="nine columns">
			<div class="four columns" style="border-bottom: 1px solid #E3E3E3">
				 ...
				 <div class="street-address"><h3><?php echo $site_name; ?></h3>Impasse Antoine Vittez<br/>Cite Dillon<br/>97200 Fort de France<br/>Martinique<br />Tel. +596 696 31 89 84</div>
			</div>
